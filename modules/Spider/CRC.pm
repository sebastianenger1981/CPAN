...
################## Subroutinen zum Erstellen von CRC Prüfsummen für die übergebenen Datei : Start
# Aufgabe: &CRCfromFile() - erstelle CRC für FILE-Filehandle
# Rückgabe: Hexwert des berechneten CRC Wertes
...
################## Subroutinen zum Erstellen von CRC Prüfsummen für die übergebenen Datei : Ende
